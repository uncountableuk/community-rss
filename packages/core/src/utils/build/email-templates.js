 ...
 * @since 0.3.0
 */
export function emailLayout(body) {
    return `<!DOCTYPE html>
<html>
 ...
 * @since 0.3.0
 */
export const signInTemplate = (context, data) => {
 ...
 * @since 0.3.0
 */
export const welcomeTemplate = (context, data) => {
    const greet = greeting(context);
 ...
 * @since 0.3.0
 */
export const emailChangeTemplate = (context, data) => {
    const greet = greeting(context);
