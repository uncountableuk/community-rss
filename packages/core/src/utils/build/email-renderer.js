 ...
 * @internal
 */
const PACKAGE_TEMPLATE_DIR = path.join(path.dirname(new URL(import.meta.url).pathname), '../../templates/email');
/**
 ...
 * @since 0.4.0
 */
export function resolveTemplatePath(name, developerDir) {
 ...
 * @since 0.4.0
 */
export function extractSubject(html) {
 ...
 * ```
 */
export function renderEmailTemplate(name, data, developerDir) {
...
//# sourceMappingURL=email-renderer.js.map