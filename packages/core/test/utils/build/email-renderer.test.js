...
import { resolveTemplatePath, extractSubject, substituteVariables, htmlToPlainText, renderEmailTemplate, } from '@utils/build/email-renderer';
...
describe('Email Renderer', () => {
    ...
    describe('renderEmailTemplate', () => {
        ...
        it('should use developer template directory when provided', () => {
            ...
            fs.mkdirSync(tmpDir, { recursive: true });
            fs.writeFileSync(path.join(tmpDir, 'sign-in.html'), '<!-- subject: Custom Sign In for {{appName}} -->\n<p>Custom: {{greeting}}</p>');
            try {
                const content = renderEmailTemplate('sign-in', {
                    appName: 'Overridden',
                    greeting: 'Hey!',
...
//# sourceMappingURL=email-renderer.test.js.map