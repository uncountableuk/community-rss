...
describe('email-service', () => {
    ...
    describe('resolveTransport', () => {
        ...
        it('should return custom transport when an object is provided', () => {
            const customTransport: EmailTransport = {
        ...
        it('should warn for unknown transport string', () => {
            ...
            expect(result).toBeNull();
            expect(warnSpy).toHaveBeenCalledWith(
                expect.stringContaining('Unknown email transport "sendgrid"'),
            );
            warnSpy.mockRestore();
        });
    });
    ...
    describe('resolveTemplate', () => {
        ...
        it('should return custom template when configured', () => {
            const customTemplate: EmailTemplateFunction<SignInEmailData> = (ctx, data) => ({
    ...
    describe('createEmailService', () => {
        ...
        it('should skip sending and warn for unknown email type', async () => {
            ...
            expect(warnSpy).toHaveBeenCalledWith(
                expect.stringContaining('No template registered for email type "nonexistent"'),
            );
            warnSpy.mockRestore();
        });
