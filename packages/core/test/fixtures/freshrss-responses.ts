import type { FreshRssSubscriptionListResponse, FreshRssStreamResponse } from '@core-types/freshrss';

export const mockFeedsResponse: FreshRssSubscriptionListResponse = {
    subscriptions: [
        {
            id: 'feed/1',
            title: 'Tech Blog',
...
export const mockArticlesResponse: FreshRssStreamResponse = {
    direction: 'ltr',
    id: 'feed/1',
    title: 'Tech Blog',
